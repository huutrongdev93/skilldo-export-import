<div class="modal fade" id="js_export_inventory_modal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
	        ...
	        <div id="js_export_inventory_form">
		        {!! Admin::loading() !!}
	            ...
	            <div class="modal-footer">
	                ...
	                <button class="btn btn-blue" type="button" id="js_export_inventory_btn_submit"><i class="fa-light fa-download"></i> {{trans('export.data')}}</button>
	            </div>
	        </div>
	        <div id="js_export_inventory_result" style="display:none;">
...
<script>
	$(function () {
		const exportInventory = new ExportInventoryHandel();
		$(document)
			.on('click', '#js_export_inventory_btn_modal', function () {
				return exportInventory.openModal($(this))
			})
			.on('click', '#js_export_inventory_btn_submit', function () {
				return exportInventory.export($(this))
			})
	})
</script>
